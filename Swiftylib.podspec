...
this is cocoapods test in idea
                   DESC
  ...
  spec.author             = { "pavanidea" => "pavan.bellana96@gmail.com" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
  ...
  spec.source       = { :git => "https://github.com/pavan9642/SwiftyLib.git", :tag => "#{4.0}" }
